...
// Deque can act as both Stack and Queue (supports both LIFO and FIFO)
// More versatile than regular queues and stacks because they support all the operations of both ds
// Implemented either using a doubly linked list or circular array
...
public class DequeDemo {
    ...
    public static void main(String[] args) {
        ...
        deque1.offerLast(25);
        // 5, 10, 20, 25
        deque1.removeFirstOccurrence(20);
        deque1.removeLastOccurrence(25);
